...
print("="*60)
print("GENERANDO PREDICCIONES TEMPORALES PARA ANIMACIÓN")
print("="*60)
...
# ==========================================
# 3. GENERAR PREDICCIONES DÍA POR DÍA
# ==========================================
print("\n3. Generando predicciones temporales...")

# Obtener fechas únicas en el período de prueba
...
# Crear carpeta para predicciones
...
# Para cada fecha, generar predicción
for i, fecha in enumerate(fechas_test):
    ...
    # Calcular probabilidad de helada (T° <= 0)
    # Usando función sigmoide: cuanto más bajo T°, mayor probabilidad
    ...
    # Nombre del archivo con formato YYYYMMDD
...
print(f"   Ubicación: limpiezadedatos/predicciones_temporales/pred_*.csv")